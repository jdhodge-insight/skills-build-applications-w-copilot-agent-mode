...
export default function Teams() {
  const codespaceEndpointTemplate = 'https://$REACT_APP_CODESPACE_NAME-8000.app.github.dev/api/teams/';
  ...
  useEffect(() => {
    ...
    console.log('Teams Codespace endpoint template:', codespaceEndpointTemplate);
    fetch(endpoint)
      .then(async (res) => {
